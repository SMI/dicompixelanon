...
# to get only the summary rows (not rects)
# in any of the image frames (ignoring any overlays).
...
out="ocr_random_combinations_files.sh_${modality}.csv.no_ovl.csv"
